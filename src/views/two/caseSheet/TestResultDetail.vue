<template>
  <div v-if="state.dialog.isShowDialog">
    <el-form ref="twoTestResultDialogFormRef" :model="state.ruleForm" :rules="state.rules" size="default"
             label-width="90px">
      <el-row :gutter="35">
        ...
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20" v-if="state.ruleForm.mriPerformed === 1">
          <el-form-item label-width="200px" label="核磁共振检查日期" prop="mriDate">
            <el-date-picker clearable v-model="state.ruleForm.mriDate" type="date" value-format="YYYY-MM-DD"
        ...
        <div v-if="state.ruleForm.biopsyPerformed === 1">
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label-width="200px" label="穿刺日期" prop="biopsyDate">
              <el-date-picker clearable v-model="state.ruleForm.biopsyDate" type="date" value-format="YYYY-MM-DD"
                              placeholder="选择穿刺日期">
              </el-date-picker>
            </el-form-item>
          </el-col>
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label-width="200px" label="穿刺结果" prop="biopsyResult">
              <el-radio-group v-model="state.ruleForm.biopsyResult">
                <el-radio v-for="dict in two_history_biopsy_result" :label="Number(dict.value)">{{
                    dict.label
                  }}
                </el-radio>
              </el-radio-group>
          ...
          <div v-if="state.ruleForm.biopsyResult === 1">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
              <el-form-item label-width="200px" label="穿刺详细结果" prop="positiveResult">
                <el-radio-group v-model="state.ruleForm.positiveResult">
                  <el-radio
                      v-for="dict in positive_result"
                      :key="dict"
                      :value="Number(dict.value)">
                    {{ dict.label }}
                  </el-radio>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20"
                    v-if="state.ruleForm.positiveResult === 4">
              <el-form-item label-width="200px" label="其他穿刺结果" prop="biopsyOtherResult">
                <el-input v-model="state.ruleForm.biopsyOtherResult" placeholder="请输入其他穿刺结果"
                          clearable></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
              <el-form-item label-width="200px" label="Gleason主要评分" prop="gleasonPrimary">
                <el-input v-model="state.ruleForm.gleasonPrimary" placeholder="请输入Gleason主要评分"
                          clearable></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
              <el-form-item label-width="200px" label="Gleason次要评分" prop="gleasonSecondary">
                <el-input v-model="state.ruleForm.gleasonSecondary" placeholder="请输入Gleason次要评分"
                          clearable></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20"
                    v-if="state.ruleForm.cancerClassification === 4">
              <el-form-item label-width="200px" label="其他前列腺癌分类详情" prop="cancerClassificationOther">
                <el-input v-model="state.ruleForm.cancerClassificationOther" placeholder="请输入前列腺癌分类详情"
                          clearable></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20" v-if="state.ruleForm.treatmentPlan === 6">
              <el-form-item label-width="200px" label="其他后续治疗方案" prop="treatmentOtherPlan">
                <el-input v-model="state.ruleForm.treatmentOtherPlan" placeholder="请输入其他后续治疗方案"
                          clearable></el-input>
              </el-form-item>
            </el-col>
          </div>
        ...
        <div v-if="state.ruleForm.biopsyResult === 0 || state.ruleForm.biopsyResult === null">
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20" v-if="state.ruleForm.bphMedication === 5">
            <el-form-item label-width="200px" label="其他BPH药物治疗" prop="bphOtherMedication">
              <el-input v-model="state.ruleForm.bphOtherMedication" placeholder="请输入其他BPH药物治疗"
                        clearable></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20"
                  v-if="state.ruleForm.bphSurgeryPerformed === 1">
            <el-form-item label-width="200px" label="BPH手术时间" prop="bphSurgeryDate">
              <el-date-picker clearable v-model="state.ruleForm.bphSurgeryDate" type="date" value-format="YYYY-MM-DD"
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20"
            ...
            <el-form-item label-width="200px" label="BPH手术治疗方式" prop="bphSurgeryType">
              <el-radio-group v-model="state.ruleForm.bphSurgeryType">
                <el-radio v-for="dict in two_history_bph_surgery_type" :value="Number(dict.value)">{{
                    dict.label
                  }}
                </el-radio>
              </el-radio-group>
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20" v-if="state.ruleForm.bphSurgeryType === 6">
            <el-form-item label-width="200px" label="BPH手术治疗其他方式" prop="bphSurgeryOtherType">
              <el-input v-model="state.ruleForm.bphSurgeryOtherType" placeholder="请输入BPH手术治疗其他方式"
                        clearable></el-input>
            </el-form-item>
          </el-col>
        </div>
...
const {
  two_history_mri_performed,
  two_history_mri_abnormality,
  two_history_clinical_stage_t,
  two_history_cancer_classification,
  two_history_bph_surgery_performed,
  two_history_isup_grade,
  two_history_treatment_plan,
  two_history_biopsy_result,
  positive_result,
  two_history_biopsy_performed,
  two_history_tumor_location,
  two_history_bph_medication,
  two_history_clinical_stage_m,
  two_history_clinical_stage_n,
...
const onSubmit = () => {
  // 验证表单
  Promise.all([currentValidate(twoTestResultDialogFormRef)]).then((res) => {
