<template>
  <div class="two-twoSymptoms-dialog-container">
    <el-dialog :title="state.dialog.title" v-model="state.dialog.isShowDialog" width="60%">
      <el-form ref="twoSymptomsDialogFormRef" :model="state.ruleForm" :rules="state.rules" size="default"
               label-width="90px">
        <el-row :gutter="35">
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="评分时间" prop="scoreTime">
              <el-date-picker clearable
                              v-model="state.ruleForm.scoreTime"
                              type="date"
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20" v-if="state.loadingData">
            <el-form-item label="IPSS数据" prop="ipssInfo">
              <dynamic-question-answer v-if="state.ruleForm.ipssInfo" :json-string="state.ruleForm.ipssInfo" @update:jsonString="handleAnswersUpdate('ipssInfo', $event)"></dynamic-question-answer>
            </el-form-item>
          </el-col>

<!--          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">-->
<!--            <el-form-item label="IPSS得分" prop="ipssScore">-->
<!--              <el-input v-model="state.ruleForm.ipssScore" placeholder="请输入IPSS得分" clearable></el-input>-->
<!--            </el-form-item>-->
<!--          </el-col>-->

          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20" v-if="state.loadingData">
            <el-form-item label="QoL数据" prop="qolInfo">
              <dynamic-question-answer v-if="state.ruleForm.qolInfo" :json-string="state.ruleForm.qolInfo" @update:jsonString="handleAnswersUpdate('qolInfo', $event)"></dynamic-question-answer>
            </el-form-item>
          </el-col>

<!--          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">-->
<!--            <el-form-item label="QoL得分" prop="qolScore">-->
<!--              <el-input v-model="state.ruleForm.qolScore" placeholder="请输入QoL得分" clearable></el-input>-->
<!--            </el-form-item>-->
<!--          </el-col>-->

          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20" v-if="state.loadingData">
            <el-form-item label="OABSS数据" prop="oabssInfo">
              <dynamic-question-answer v-if="state.ruleForm.oabssInfo" :json-string="state.ruleForm.oabssInfo" @update:jsonString="handleAnswersUpdate('oabssInfo', $event)"></dynamic-question-answer>
            </el-form-item>
          </el-col>

<!--          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">-->
<!--            <el-form-item label="OABSS得分" prop="oabssScore">-->
<!--              <el-input v-model="state.ruleForm.oabssScore" placeholder="请输入OABSS得分" clearable></el-input>-->
<!--            </el-form-item>-->
<!--          </el-col>-->
        </el-row>
      </el-form>
...
import DynamicQuestionAnswer from './DynamicQuestionAnswer.vue';
...
const onSubmit = () => {
  // 验证表单
  Promise.all([
    currentValidate(twoSymptomsDialogFormRef),
  ]).then(res => {
